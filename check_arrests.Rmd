...
```{r}
res_df = features %>% 
        filter(person_id %in% c(799, 1284, 10774, 1638, 8491, 1515, 1394, 8200, 5722, 6337, 6886, 10553, 3145, 3291, 11414, 7997, 1497, 11231, 11096, 11312)) %>%
        select(person_id, screening_date, name, p_charge, p_arrest) %>%
