...
```{r}
ggsave("Figures/age_analysis_figs_general/age_first_offense_general_scales0.pdf",plot = age_first_offense_general_scales0, width = 6.5, height = 4, units = "in")

ggsave("Figures/age_analysis_figs_general/age_first_offense_general_scales1.pdf",plot = age_first_offense_general_scales1, width = 6.5, height = 4, units = "in")
