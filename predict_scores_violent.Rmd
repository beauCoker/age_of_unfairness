...
```{r}
ggsave("Figures/age_LB_violent.pdf",plot = age_spline_viol, width = 3.5, height = 2.5, units = "in")
```
...
```{r}
ggsave("Figures/age_LB_alldata_violent.pdf",plot = age_spline_viol_all, width = 3.5, height = 2.5, units = "in")
```
...
## Group 1 models: predicting (raw - age spline) without using age variables or race
