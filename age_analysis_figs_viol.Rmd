...
```{r}
ggsave("Figures/age_analysis_figs_viol/age_first_offense_viol_scales0.pdf", plot = age_first_offense_viol_scales0, width = 3.5, height = 2.5, units = "in")

ggsave("Figures/age_analysis_figs_viol/age_first_offense_viol_scales1.pdf", plot = age_first_offense_viol_scales1, width = 3.5, height = 2.5, units = "in")
