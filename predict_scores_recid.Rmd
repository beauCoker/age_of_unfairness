...
# Extra Group: predict age remainder without age at first arrest, current age, and race
...
RMSE without age at first arrest is .5358, RMSE with age at first arrest is .5227 (get higher error without age at first arrest)
```{r}
# compare to group 1 (with age-first-arrest, but without current age and race)
res_rmse
```
