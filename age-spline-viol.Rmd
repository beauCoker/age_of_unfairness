...
load("Table_construction2.Rdata")
```
...
Risk of Violence
Initially modelled age with a 4th degree polynomial. 
## Fit age polynomial
```{r}
...
ggsave("Figures/age_spline_viol_all.pdf",plot = age_spline_viol_all, width = 6, height = 4, units = "in")
